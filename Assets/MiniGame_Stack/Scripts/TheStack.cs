...
public class TheStack : MonoBehaviour
{
    ...
    private const float MonvingBoundsSize = 3f;
    ...
    void MoveBlock()
    {
        ...
        if (isMovingX)
        {
            lastBlock.localPosition = new Vector3(
                movePosition * MonvingBoundsSize, stackCount, secondaryPosition);
        }
        else
        {
            lastBlock.localPosition = new Vector3(
                secondaryPosition, stackCount, movePosition * MonvingBoundsSize);
        }
    }
